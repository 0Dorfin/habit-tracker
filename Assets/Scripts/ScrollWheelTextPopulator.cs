...
public class ScrollWheelTextPopulator : MonoBehaviour, IBeginDragHandler, IEndDragHandler
{
    [Header("Referencias")]
    ...
    private float totalContentHeight => opciones.Count * itemHeight;
    ...
    IEnumerator SnapToNearest()
    {
        ...
        nearestIndex = Mathf.Clamp(nearestIndex, 0, opciones.Count - 1);
    ...
    public string GetSelectedText()
    {
        ...
        index = Mathf.Clamp(index, 0, opciones.Count - 1);
